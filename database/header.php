...
$allowedViews = ['network','hardware','software','location','rooms','logs','users'];
...
/* ACTION BTNS */
.action-btn{width:28px;height:28px;border-radius:8px;border:.5px solid var(--color-border-tertiary);background:transparent;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;color:var(--color-text-secondary);font-size:14px;}
  ...
  <div class="sidebar">
    ...
    <div class="sb-nav">
      ...
      <div class="sb-group">
        ...
        <a href="index.php?view=rooms" class="sb-item <?= $view=='rooms'?'active':'' ?>">
